public class Flat extends Immo {
	...
	public Flat(double prise, double squareMeter, double otherKosts, double nettoRent,
				double maintenanceCosts,double taxBurden, String immoName
	) {
